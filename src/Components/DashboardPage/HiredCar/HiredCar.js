      ...
      <Card style={{ width: "20rem" }}>
        ...
        <Card.Body>
          ...
          <div className="d-flex justify-content-between">
            ...
            <h6>
              {hire.orderStatus === "Hired" && (
                <Badge bg="danger">{hire.orderStatus}</Badge>
              )}
              {hire.orderStatus === "On The Way" && (
                <Badge bg="warning" style={{ color: "black" }}>
                  {hire.orderStatus}
                </Badge>
              )}
              {hire.orderStatus === "Complete" && (
                <Badge bg="success">{hire.orderStatus}</Badge>
              )}
            </h6>
          </div>
